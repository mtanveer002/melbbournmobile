$(document).ready(function() {
    ...
    $('#quote_export').click(function() {
        open($('select[name=results-air_length]'));
        $("select[name=results-air_length]").val('-1').trigger('change');
        ...
        if(qtdTarifasSelecionadas == 0){
           ...
           document.getElementById('frmQuote').action = '/expreco/public/get-a-quote';
...
$(document).ready(function() {
    ...
    $('#quote_excel').click(function() {
        ...
        if(qtdTarifasSelecionadas == 0){
            ...
            //document.getElementById('frmQuote').action = '/get-a-excel';
            //document.getElementById('frmQuote').submit();
        }
    });
...
$(document).ready(function(){
   $('#yesToAddServices').click(function(){
      document.getElementById('frmQuote').action = '/expreco/public/get-a-excel';
      document.getElementById('frmQuote').submit();
   });
});
